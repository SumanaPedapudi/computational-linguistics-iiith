...
function hs() {
	// body...
	var a = Math.floor(Math.random()*sh1.length);
	var b = sh1[a];
	var c = s(b);
	button(c);
}
...
function button(n) {
 ...
 $(".nc").click(function(){
			...
			document.getElementById("fs").innerHTML = "<b>Formed Sentence</b>"+"<i>(after selecting words)</i>";
    ...
    $("button").click(function(){
		document.getElementById("rf").innerHTML = null;
     		...
     		b.innerHTML = "Re-form the sentence"
     		var d = document.getElementById("rf");
     		d.appendChild(b)
})
} 
document.getElementById("rf").innerHTML=null;
